    ...
    <section className="flex my-20 justify-center items-center services-bg">
      <div className="w-full h-full lg:flex gap-20 items-center backdrop-brightness-[.3]">
        <div className="px-10 py-10 mx-auto lg:w-[70%]">
          <div className="lg:bg-primary lg:h-80 lg:w-40 rounded-2xl">
            <div className="lg:absolute lg:top-[20%] lg:left-[7%] lg:w-[40%] flex flex-col lg:items-start items-center">
              <h1
                className="md:text-5xl text-4xl md:w-[80%] text-wrap text-white mb-5 lg:text-left text-center font-sans"
                data-aos="fade-up"
              ...
              <p
                className="md:text-lg lg:text-sm md:w-[85%] text-white mb-5 lg:text-left text-center"
                data-aos="fade-up"
              ...
              {Services.map((services) => (
                <SwiperSlide key={services.id}>
                  <div className="group flex flex-col justify-start items-start gap-24 w-72 h-72 duration-500 relative rounded-lg p-4 bg-black bg-opacity-60 backdrop-blur-lg hover:-translate-y-2 hover:shadow-xl shadow-gray-800 border-[1px] border-[#efefef60]">
                    <div className="absolute duration-700 shadow-md group-hover:-translate-y-4 group-hover:-translate-x-4 -bottom-10 -right-10 w-1/2 h-1/2 rounded-lg bg-primary z-50"></div>
                    <div>
                      <h2 className="absolute md:top-[50%] top-[90%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-9xl font-bold mb-2 text-gray-100 opacity-10 tracking-widest font-sans">
                        {services.num}
                      </h2>
                      <p
                        className="text-gray-200 line-clamp-3 mt-9 text-3xl capitalize"
                        data-aos="fade-up"
                        data-aos-duration="700"
                        data-aos-easing="ease-in-sine"
                      >
              ...
              <SwiperSlide key={services.id}>
                <div className="group flex flex-col justify-start items-start gap-24 w-72 h-72 duration-500 relative rounded-lg p-4 bg-black bg-opacity-60 backdrop-blur-lg hover:-translate-y-2 hover:shadow-xl shadow-gray-800 border-[1px] border-[#efefef60]">
                  <div
                    ...
                    data-aos-duration="700"
                    data-aos-easing="ease-in-sine"
                    className="absolute duration-700 shadow-md group-hover:-translate-y-4 group-hover:-translate-x-4 -bottom-10 -right-10 w-1/2 h-1/2 rounded-lg bg-primary z-50"
                  ></div>
                  <div>
                    <h2 className="absolute md:top-[50%] top-[90%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-9xl font-bold mb-2 text-gray-100 opacity-10 tracking-widest font-sans">
                      {services.num}
